...
<div class="card">
    ...
    <div class="card-body">
        @include('profile::forms.edit.partials.menu')
        <!-- Tab panes -->
        <form action="{{route('admin.employee.personal-detail.update',['id'=>$personalDetail->id])}}" method="POST">
            @csrf
            <div class="tab-content">
                <div class="tab-pane fade active show">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <input type="hidden" name="user_id" value="{{$personalDetail->user_id}}">
                            <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="date_of_birth" id="" class="form-control date-of-birth"
                                            value="{{old('date_of_birth',isset($personalDetail->date_of_birth)? $personalDetail->date_of_birth:null)}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="motorcycle_reg_number" id="" class="form-control"
                                            value="{{old('motorcycle_reg_number',isset($personalDetail->motorcycle_reg_number)? $personalDetail->motorcycle_reg_number:null)}}">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
