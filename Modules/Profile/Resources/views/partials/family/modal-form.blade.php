<div class="modal fade" id="add-family-records" tabindex="-1" role="dialog" aria-labelledby="add-family-records"
    aria-hidden="true">
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Family Records</h5>
