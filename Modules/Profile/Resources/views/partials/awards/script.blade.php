<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#addrow").on("click", function () {
            ...
            cols += '<td><input type="text" class="form-control received-date" name="received_date[]" /></td>';
            cols += '<td><input type="text" class="form-control" name="notes[]" /></td>';
            cols += '<td><input type="button" class="ibtnDel btn btn-block btn-danger " value="Remove"></td>';
            newRow.append(cols);
