...
<ul class="nav nav-tabs" id="myTab" role="tablist">
    <li class="nav-item">
        <a class="nav-link {{active($admin_link.'/leaves/status/submitted')}}" href="{{route('leave.admin.index',['status'=>'submitted'])}}" role="tab" aria-controls="active"
            aria-selected="true">Active Applications</a>
    </li>
    <li class="nav-item">
        <a class="nav-link {{active('leaves/withdrawn')}}"  href="#" role="tab" aria-controls="withdrawn"
