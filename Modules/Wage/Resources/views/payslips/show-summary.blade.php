...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-options text-right font-weight-bold">
                <p>Total Employer Expenses :
                    MYR {{number_format($summary->employer_expenses,2,'.','') ?? 0.00}}</p>
            <a href="{{route('pdf',['month'=>$summary->month,'year'=>$summary->year])}}" class="btn btn-primary btn-sm" id="exportpdf">Export To PDF</a>  
            <a href="{{route('print.payslip.summary',['month'=>$summary->month,'year'=>$summary->year])}}" class="btn btn-primary btn-sm" target="_blank">Print</a>
        </div>
    </div>
    <div class="card-body">
