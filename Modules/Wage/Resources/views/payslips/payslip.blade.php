...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-options">
            <a class="btn btn-primary btn-sm pull-right" target="_blank" href="{{URL::signedRoute('payslip.print',['id'=>$payslip->user_id,'month'=>$payslip->month,'year'=>$payslip->year])}}">Print</a>
        </div>
    </div>
    <div class="card-body">
        <div class="row">
